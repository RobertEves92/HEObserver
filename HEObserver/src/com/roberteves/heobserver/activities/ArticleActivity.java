...
public class ArticleActivity extends Activity {
    ...
    private boolean articleSupported() {
        return article.isReadable() && article.getLink().matches("((http://)?)((m.)?)((www.)?)hertsandessexobserver.co.uk/.*story.html") && !article.getLink().toUpperCase().contains("UNDEFINED-HEADLINE");
    }
